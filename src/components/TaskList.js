...
export default class TaskList extends Component {
	...
	generateTask(item, index) {
		...
		return (
			<div key={index}>
				<Task task={item} index={index} del={this.delTask} upd={this.updTask} initColumnTitle={this.props.column.props.title} currentColumnTitle={this.props.column.state.title}/>
			</div>
		);
	}
